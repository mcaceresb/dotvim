...
" Updated: Sat 27 Jun 2015 12:18:47 AM EDT
...
" let g:neocomplete#force_omni_input_eopatterns = {'tex' : '\v\\\a*(ref|cite)\a*\**([^]]*\])?\{(|[^}]*,)'}
