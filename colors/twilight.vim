...
let s:beige = '#ceb67f'
"let s:light_beige = '#d6b46b'
let s:light_beige = '#ccb076'
...
if version >= 700
  ...
  "hi MatchParen guifg=white guibg=#80a090 gui=bold,italic
  hi MatchParen guifg=white guibg=NONE gui=bold,italic
  ...
  hi Pmenu guifg=#aaaaaa guibg=#303030
...
exe 'hi Statement      guifg='.s:light_beige       .' guibg='.s:darkgrey        .' gui=none'
